...
export const FileApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        apiFilePost: async (pilotId?: number, file?: any, options: any = {}): Promise<RequestArgs> => {
...
export class FileApi extends BaseAPI {
     ...
     * @memberof FileApi
     */
    public apiFilePost(pilotId?: number, file?: any, options?: any) {
        return FileApiFp(this.configuration).apiFilePost(pilotId, file, options).then((request) => request(this.axios, this.basePath));
    }
}
